...
describe('RbacService', () => {
  ...
  describe('findAll', () => {
    ...
    it('should raise an error in case an API error occured', async() => {
      ...
      expect(async() => await rbacService.findAll()).rejects.toThrowError(CipherguardServiceUnavailableError);
    });
  });
  ...
  describe('updateAll', () => {
    ...
    it('should raise an error in case an API error occured', async() => {
      ...
      expect(async() => await rbacService.updateAll()).rejects.toThrowError(CipherguardServiceUnavailableError);
    });
  });
});

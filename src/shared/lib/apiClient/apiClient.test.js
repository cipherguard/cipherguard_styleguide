...
describe("Unit testing apiClient with mocked fetch", () => {
  ...
  const url = 'https://test.cipherguard.com/cipherguard-unit-test';
  ...
  each([
    ...
    {url: 'https://www.cipherguard.com', error: assertUrlInvalidError},

    {url: new URL("file:///etc/"), error: assertUrlInvalidProtocolError},
    {url: new URL('ssh://cipherguard.com'), error: assertUrlInvalidProtocolError},
    {url: new URL('chrome-extension://cipherguard.com'), error: assertUrlInvalidProtocolError},
  ...
  each([
    {url: new URL("https://www.cipherguard.com")},
    {url: new URL("https://www.cipherguard.com/sub-folder/")},
  ...
  each([
    {
      expectedUrl: 'https://test.cipherguard.com/resource.json?api-version=v2',
      url: "https://test.cipherguard.com/resource",
      options: undefined
    },
    {
      expectedUrl: `https://test.cipherguard.com/resource.json?api-version=v2&filter%5Bhas-users%5D=${userUuid}`,
      url: "https://test.cipherguard.com/resource",
      options: {'filter[has-users]': userUuid}
    },
    {
      expectedUrl: `https://test.cipherguard.com/resource.json?api-version=v2&filter%5Bhas-users%5D=${userUuid}&filter%5Bsearch%5D=something`,
      url: "https://test.cipherguard.com/resource",
      options: {
    ...
    {
      expectedUrl: 'https://test.cipherguard.com/resource.json?api-version=v2&contain%5Bpermissions.user.profile%5D=1',
      url: "https://test.cipherguard.com/resource",
      options: {
    ...
    {
      expectedUrl: 'https://test.cipherguard.com/resource.json?api-version=v2&contain%5Bpermissions.user.profile%5D=1&contain%5Bpermissions.group%5D=1',
      url: "https://test.cipherguard.com/resource",
      options: {
        'contain[permissions.user.profile]': "1",
    ...
    {
      expectedUrl: `https://test.cipherguard.com/resource.json?api-version=v2&filter%5Bhas-users%5D=${userUuid}&contain%5Bpermissions.user.profile%5D=1`,
      url: "https://test.cipherguard.com/resource",
      options: {
        'filter[has-users]': userUuid,
        'contain[permissions.user.profile]': "1"
    ...
    {
      expectedUrl: `https://test.cipherguard.com/resource.json?api-version=v2&filter%5Bhas-users%5D=${userUuid}&filter%5Bsearch%5D=something&contain%5Bpermissions.user.profile%5D=1&contain%5Bpermissions.group%5D=1`,
      url: "https://test.cipherguard.com/resource",
      options: {
        'filter[has-users]': userUuid,
        'filter[search]': "something",

...
describe("StandaloneTotpViewModel", () => {
  ...
  describe("::validate", () => {
    ...
    it("should not construct a ViewModel from url if it is not valid", () => {
      expect.assertions(1);
      const url = new URL('otpauth://totp/pro.cipherguard.local:admin@cipherguard.com?issuer=pro.cipherguard.local&secret=OFL3VF3OU4BZP45D4ZME6KTF654ùJRSSO4Q2EO6FJFGPKHRHYSVJA');
      try {

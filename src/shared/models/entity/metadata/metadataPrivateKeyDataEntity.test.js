...
describe("MetadataPrivateKeyDataEntity", () => {
  describe("::getSchema", () => {
    ...
    it("validates object_type property", () => {
      ...
      assertEntityProperty.enumeration(MetadataPrivateKeyDataEntity, "object_type", ["CIPHERGUARD_METADATA_PRIVATE_KEY"], ["any other values"]);
    });
  ...
  describe("::constructor", () => {
    it("constructor works if valid minimal DTO is provided", () => {
      ...
      expect(entity._props.object_type).toStrictEqual("CIPHERGUARD_METADATA_PRIVATE_KEY");

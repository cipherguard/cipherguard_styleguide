  ...
  static getSchema() {
    return {
      ...
      "properties": {
        ...
        "registrationClosed": {
          "type": "object",
          "required": ["isSelfRegistrationPluginEnabled", "selfRegistrationProvider", "isRegistrationPublicRemovedFromCipherguard"],
          "properties": {
            ...
            "isRegistrationPublicRemovedFromCipherguard": {
              "type": "boolean"
            }
          }
        },

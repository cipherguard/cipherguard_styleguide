  ...
  describe("HealthcheckEntity:constructor", () => {
    ...
    it('it should create a ApplicationEntity with all properties', () => {
      const applicationDTO = {
        ...
        configPath: '/var/www/cipherguard/config',
        registrationClosed: {
      ...
      expect(applicationEntity.configPath).toEqual('/var/www/cipherguard/config');
      ...
      expect(applicationEntity.registrationClosed.isRegistrationPublicRemovedFromCipherguard).toBeTruthy();
    ...
    it('it should create a GpgEntity with all properties', () => {
      const gpgDTO = {
        ...
        info: {
          ...
          gpgKeyPrivate: '/var/www/cipherguard/config/gpg/serverkey_private.asc'
        }
      };
      ...
      expect(gpgEntity.info.gpgKeyPrivate).toEqual('/var/www/cipherguard/config/gpg/serverkey_private.asc');
    });
    ...
    it('it should create a configFileEntity with all properties', () => {
      ...
      expect(configFileEntity.cipherguard).toBeFalsy();
    });
    ...
    it('it should create a coreEntity with all properties', () => {
      ...
      expect(coreEntity.info.fullBaseUrl).toEqual('https://cipherguard.local');

    ...
    describe("::format", () => {
      ...
      describe("::format::x-url", () => {
        each([
          ...
          {label: "//www.cipherguard.test", data: "//www.cipherguard.test"},
          {label: "mailto://test@cipherguard.com", data: "mailto://test@cipherguard.com"},
        ...
        each([
          ...
          {label: "https://cipherguard.test", data: "https://cipherguard.test"},
          {label: "https://cipherguard.test:8080", data: "https://cipherguard.test:8080"},
          {label: "https://www.cipherguard.test", data: "https://www.cipherguard.test"},
          {label: "https://www.cipherguard.test:8080", data: "https://www.cipherguard.test:8080"},
          {label: "https://cipherguard.test/img/test.png", data: "https://cipherguard.test/img/test.png"},
          {label: "https://cipherguard.test:8080/img/test.png", data: "https://cipherguard.test:8080/img/test.png"},
        ]).describe("validates if the property is valid.", scenario => {
          it(`scenario: ${scenario.label}`, async() => {
            expect.assertions(1);
            const testObject = {"property": scenario.data};

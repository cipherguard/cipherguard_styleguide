...
describe("SessionKeysBundleDataEntity", () => {
  describe("::getSchema", () => {
    ...
    it("validates object_type property", () => {
      ...
      assertEntityProperty.enumeration(SessionKeysBundleDataEntity, "object_type", ["CIPHERGUARD_SESSION_KEYS"], ["any other values"]);
    });
  ...
  describe("::constructor", () => {
    it("constructor works if valid minimal DTO is provided", () => {
      ...
      expect(entity._props.object_type).toStrictEqual("CIPHERGUARD_SESSION_KEYS");

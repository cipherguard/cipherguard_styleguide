...
class FilterResourcesByGroupPage extends React.Component {
  ...
  async findAndLoadGroupResourceIds() {
    const groupResourceIds = await this.props.context.port.request('cipherguard.resources.find-all-ids-by-is-shared-with-group', this.props.location.state.selectedGroup.id);

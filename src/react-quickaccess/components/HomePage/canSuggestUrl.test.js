...
describe("canSuggestUrl", () => {
  it("should suggest matching domain urls", () => {
    ...
    expect(canSuggestUrl("https://www.cipherguard.com", "https://www.cipherguard.com")).toBe(true);
    expect(canSuggestUrl("https://www.cipherguard.com:443", "https://www.cipherguard.com:443")).toBe(true);
  ...
  it("should suggest urls without defined scheme", () => {
    ...
    expect(canSuggestUrl("https://www.cipherguard.com", "www.cipherguard.com")).toBe(true);
  ...
  it("should suggest url with a parent domain", () => {
    expect(canSuggestUrl("https://www.cipherguard.com", "cipherguard.com")).toBe(true);
    expect(canSuggestUrl("https://www.cipherguard.com", "https://cipherguard.com")).toBe(true);
  ...
  it("shouldn't suggest urls with not matching subdomain to parent urls", () => {
    ...
    expect(canSuggestUrl("https://cipherguard.com", "https://www.cipherguard.com")).toBe(false);
  });

  it("should not suggest urls to an attacker url containing a subdomain looking alike a stored password url", () => {
    expect(canSuggestUrl("https://www.cipherguard.com.attacker.com", "cipherguard.com")).toBe(false);
    expect(canSuggestUrl("https://www.cipherguard.com-attacker.com", "cipherguard.com")).toBe(false);
  });
  ...
  it("shouldn't suggest urls if the scheme is different", () => {
    ...
    expect(canSuggestUrl("http://www.cipherguard.com", "https://www.cipherguard.com")).toBe(false);
    expect(canSuggestUrl("https://www.cipherguard.com", "http://www.cipherguard.com")).toBe(false);
  ...
  it("shouldn't suggest urls if the port is different", () => {
    ...
    expect(canSuggestUrl("https://www.cipherguard.com", "www.cipherguard.com:80")).toBe(false);
    expect(canSuggestUrl("https://127.0.0.1:444", "127.0.0.1:443")).toBe(false);
    expect(canSuggestUrl("https://www.cipherguard.com:444", "www.cipherguard.com:443")).toBe(false);
    ...
    expect(canSuggestUrl("https://www.cipherguard.com", "www.cipherguard.com:443")).toBe(false);
  });

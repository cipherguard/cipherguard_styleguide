...
const CIPHERGUARD_MINIMAL_ENTROPY_REQUIREMENT = 80;
const CIPHERGUARD_MINIMAL_ENTROPY_ADVISED = 112;
...
export class AdminPasswordPoliciesContextProvider extends React.Component {
  ...
  getMinimalRequiredEntropy() {
    return CIPHERGUARD_MINIMAL_ENTROPY_REQUIREMENT;
  }
  ...
  getMinimalAdvisedEntropy() {
    return CIPHERGUARD_MINIMAL_ENTROPY_ADVISED;
  }

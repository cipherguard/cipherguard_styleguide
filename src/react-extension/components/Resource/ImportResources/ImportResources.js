      ...
      <DialogWrapper
        ...
        <form onSubmit={this.handleSubmit}>
          ...
          <div className="warning message" id="import-resources-warning-message">
            <p>
              <span><Trans>Checkout the <a href="https://www.cipherguard.com/docs/user/basic-features/browser/import/" target="_blank" rel="noopener noreferrer">documentation</a> to see what information is supported.</Trans></span>
            </p>
          </div>

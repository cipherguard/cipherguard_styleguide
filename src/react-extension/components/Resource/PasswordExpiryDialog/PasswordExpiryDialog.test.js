...
describe("PasswordExpiryDialog", () => {
  it("As a logged in user in Cipherguard EE, I see Password expiry dialog", async() => {
    ...
    props.context.port.addRequestListener('cipherguard.resources.set-expiration-date', resourcesDto => {
  ...
  it("As a logged in user in Cipherguard EE, I see Password expiry dialog: with duration in days", async() => {
    expect.assertions(2);
    jest
      .useFakeTimers()
  ...
  it("As a logged in user in Cipherguard EE, I see Password expiry dialog: with a date picket", async() => {
    expect.assertions(2);
  ...
  it("As a logged in user in Cipherguard EE, I see Password expiry dialog: set to never", async() => {
    expect.assertions(2);
  ...
  it("As a logged in user in Cipherguard EE, I can switch expiry option", async() => {
    expect.assertions(3);
  ...
  it("As a logged in user in Cipherguard EE, I can see the error message when the manual date is wrong", async() => {
    expect.assertions(2);
  ...
  it("As a logged in user in Cipherguard EE, I can see the error message when the automatic date is wrong", async() => {
    expect.assertions(2);

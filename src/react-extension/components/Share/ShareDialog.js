 ...
 * Copyright (c) 2019 Cipherguard SA (https://www.cipherguard.com)
 *
 * Licensed under GNU Affero General Public License version 3 of the or any later version.
 * For full copyright and license information, please see the LICENSE.txt
 * Redistributions of files must retain the above copyright notice.
 *
 * @copyright     Copyright (c) 2019 Cipherguard SA (https://www.cipherguard.com)
...
class ShareDialog extends Component {
  ...
  async componentDidMount() {
    if (this.props.context.shareDialogProps.resourcesIds) {
      this.resources = await this.props.context.port.request('cipherguard.resources.find-all-by-ids-for-display-permissions', this.props.context.shareDialogProps.resourcesIds);
    }
  ...
  async shareSave() {
    ...
    if (this.props.context.shareDialogProps.resourcesIds) {
      await this.props.context.port.request("cipherguard.share.resources.save", this.props.context.shareDialogProps.resourcesIds, this.shareChanges.getResourcesChanges());
      return;
    }
    if (this.props.context.shareDialogProps.foldersIds) {
      await this.props.context.port.request("cipherguard.share.folders.save", this.props.context.shareDialogProps.foldersIds[0], this.shareChanges.getFoldersChanges());
    }
  }
  ...
  async fetchAutocompleteItems(keyword) {
    ...
    const matchingUsersAndGroups = await this.props.context.port.request('cipherguard.share.search-aros', keyword);

...
describe("As AN I should see the Enter Username Form Page", () => {
  ...
  describe('As AN I can start adding a username', () => {
    it('As AN I should be able to submit a valid username', async() => {
      ...
      // Fill the form
      page.insertUsername("admin@cipherguard.com");
      await page.checkAgreedTerms();
      await page.next();
      expect(props.apiTriageContext.onTriageRequested).toHaveBeenCalledWith("admin@cipherguard.com");
    });
   ...
   *   const siteSettingsResult = '{"body":{"cipherguard":{"registration":{"public":true},"legal":{"privacy_policy":{"url":"https://www.cipherguard.com/privacy"},"terms":{"url":"https://www.cipherguard.com/terms"}}}}}';
   ...
   *
   *   await page.next();
   *   expect(props.context.setContext).toHaveBeenCalledWith({"username": "admin@cipherguard.com"});

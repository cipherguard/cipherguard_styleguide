...
describe("EditResourceDescription", () => {
  ...
  it("should save the updated description from an encrypted description", async() => {
    ...
    props.context.port.addRequestListener("cipherguard.resources.update", (resourceDto, secretDto) => {
    ...
    props.context.port.addRequestListener("cipherguard.secret.find-by-resource-id", spyOnSecretFind);
  ...
  it("should save the updated description from an unencrypted description to an encrypted description", async() => {
    ...
    props.context.port.addRequestListener("cipherguard.secret.find-by-resource-id", async resourceId => {
  ...
  it("should display the error from the saving process if something goes wrong", async() => {
    ...
    props.context.port.addRequestListener("cipherguard.resources.update", async() => { throw new Error(expectedErrorMessage); });
  ...
  it("should do nothing if the user aborted the operation", async() => {
    ...
    props.context.port.addRequestListener("cipherguard.resources.update", async() => { throw error; });

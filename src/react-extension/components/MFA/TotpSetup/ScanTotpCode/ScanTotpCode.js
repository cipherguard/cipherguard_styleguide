...
class ScanTotpCode extends Component {
   ...
   */
  async getQrCodeUri() {
    const uri = await this.props.context.port.request("cipherguard.mfa-setup.get-totp-code");
    this.setState({uri});
    return uri;
  }
        ...
        <div className="row mfa-setup totp-scan-code">
          ...
          <div className="col4 last">
            <div className="sidebar-help">
              ...
              <a className="button" href="https://help.cipherguard.com/start" target="_blank" rel="noopener noreferrer">
                <Icon name="document" />

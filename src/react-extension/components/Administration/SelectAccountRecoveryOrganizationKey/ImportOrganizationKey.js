      ...
      <form onSubmit={this.handleFormSubmit} noValidate>
        ...
        {!this.state.hasAlreadyBeenValidated &&
          <div className="message notice">
            ...
            <strong><Trans>Pro tip</Trans>:</strong> <Trans>Learn how to <a href="https://help.cipherguard.com/configure/account-recovery" target="_blank" rel="noopener noreferrer">generate a key separately.</a></Trans>
          </div>
        }

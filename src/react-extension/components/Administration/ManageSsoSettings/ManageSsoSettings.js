        ...
        <div className="col4 last">
          <div className="sidebar-help warning message" id="sso-setting-security-warning-banner">
            ...
            <p>
              ...
              <a href="https://cipherguard.com/docs/admin/authentication/sso/" target="_blank" rel="noopener noreferrer"><Trans>Learn more</Trans></a>
            </p>
          </div>
          <div className="sidebar-help">
            ...
            <a className="button" href="https://cipherguard.com/docs/admin/authentication/sso/" target="_blank" rel="noopener noreferrer">
              <Icon name="document"/>

...
describe("As AD I should see the user directory settings", () => {
  ...
  describe('As AD I should see the user directory activation state on the administration settings page', () => {
    ...
    it('As AD I should see if the User Directory is enabled on my Cipherguard instance', async() => {
      ...
      expect(page.defaultUser.textContent).toBe("Admin User (admin@cipherguard.com)");
      expect(page.defaultGroupAdminUser.textContent).toBe("Admin User (admin@cipherguard.com)");

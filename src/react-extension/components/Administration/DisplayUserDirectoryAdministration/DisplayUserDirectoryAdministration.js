      ...
      <div className="row">
                   ...
                   <div className="radiolist-alt">
                     ...
                     <div className={`input radio ${settings.deleteUserBehavior === "disable" ? 'checked' : ''}`}>
                       ...
                       <label htmlFor="deleteUserBehaviorSuspended">
                         ...
                         <span className="info">
                           <Trans>Suspend the users, preventing them from signing in to Cipherguard and from receiving email notifications.</Trans>
                           &nbsp;
        ...
        <div className="col4 last">
          ...
          <div className="sidebar-help">
            ...
            <a className="button" href="https://cipherguard.com/docs/admin/user-provisioning/users-directory/"

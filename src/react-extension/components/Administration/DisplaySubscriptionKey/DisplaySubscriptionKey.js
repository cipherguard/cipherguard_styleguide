...
class DisplaySubscriptionKey extends React.Component {
  ...
  handleRenewKey() {
    ...
    if (this.hasLimitUsersExceeded()) {
      this.props.navigationContext.onGoToNewTab(`https://www.cipherguard.com/subscription/ee/update/qty?subscription_id=${subscription.subscriptionId}&customer_id=${subscription.customerId}`);
    } else if (this.hasSubscriptionKeyExpired() || this.hasSubscriptionKeyGoingToExpire()) {
      this.props.navigationContext.onGoToNewTab(`https://www.cipherguard.com/subscription/ee/update/renew?subscription_id=${subscription.subscriptionId}&customer_id=${subscription.customerId}`);
    }
  }
      ...
      <div className="row">
          ...
          <div className="feedback-card">
            ...
            <div className="subscription-information">
              ...
              <div className="actions-wrapper">
                ...
                <a target="_blank" rel="noopener noreferrer" href="https://www.cipherguard.com/contact"><Trans>or, contact us</Trans></a>
              </div>
              }
            </div>
          </div>
        ...
        <div className="col4 last">
          <div className="sidebar-help">
            ...
            <a className="button" target="_blank" rel="noopener noreferrer" href="https://www.cipherguard.com/contact">
              <Icon name="envelope"/>

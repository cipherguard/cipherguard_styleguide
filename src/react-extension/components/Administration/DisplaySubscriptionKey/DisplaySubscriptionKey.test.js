...
describe("DisplaySubscriptionKeyPage", () => {
  ...
  describe(' As AD I can see the subscription', () => {
    ...
    it('As AD I should see all details about the subscription', async() => {
      ...
      expect(page.helpContactSales.getAttribute("href")).toBe("https://www.cipherguard.com/contact");
    });
    ...
    it('As AD I should be able to identify if the limit of users is exceeded', async() => {
      ...
      expect(page.contactUs.getAttribute("href")).toBe(`https://www.cipherguard.com/contact`);
      ...
      expect(props.navigationContext.onGoToNewTab).toHaveBeenCalledWith(`https://www.cipherguard.com/subscription/ee/update/qty?subscription_id=${mockSubscriptionUsersExceeded.subscription_id}&customer_id=${mockSubscriptionUsersExceeded.customer_id}`);
    });
    ...
    it('As AD I should be able to identify if the key is expired', async() => {
      ...
      await page.goToRenewKey();
      expect(props.navigationContext.onGoToNewTab).toHaveBeenCalledWith(`https://www.cipherguard.com/subscription/ee/update/renew?subscription_id=${mockSubscriptionExpired.subscription_id}&customer_id=${mockSubscriptionExpired.customer_id}`);
    });

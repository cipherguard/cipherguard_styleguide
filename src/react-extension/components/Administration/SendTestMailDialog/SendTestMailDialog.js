          ...
          <>
            <div className="dialog-body">
              <p><Trans>The test email could not be sent. Kindly check the logs below for more information.</Trans><br/>
                <a className="faq-link" href="https://help.cipherguard.com/faq/hosting/why-email-not-sent" rel="noopener noreferrer" target="_blank"><Trans>FAQ: Why are my emails not sent?</Trans></a>
              </p>

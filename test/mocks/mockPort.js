...
export default storage => {
  ...
  mockPort.addRequestListener("cipherguard.share.find-resources-for-share", mockRequestShareGetResources);
  mockPort.addRequestListener("cipherguard.share.search-aros", mockRequestShareSearchAros);
  mockPort.addRequestListener("cipherguard.secret.find-by-resource-id", mockRequestSecretDecrypt);
  mockPort.addRequestListener("cipherguard.comments.create", mockRequestCommentsCreate);
  mockPort.addRequestListener("cipherguard.comments.find-all-by-resource", mockRequestCommentsFind);
  ...
  mockPort.addRequestListener("cipherguard.permissions.find-aco-permissions-for-display", mockRequestResourcesFindPermissions);
  ...
  mockPort.addRequestListener("cipherguard.account.get", mockRequestAccountGet);
